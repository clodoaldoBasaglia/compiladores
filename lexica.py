...
tokens = ['DIVISAO','VIRGULA','ATRIBUICAO','MENOR','MAIOR','IGUAL','MENOR_IGUAL','MAIOR_IGUAL','ABRE_PARENTESES','FECHA_PARENTESES','DOIS_PONTOS','ID','SOMA','SUBTRACAO','NOVA_LINHA','MULTIPLICACAO']+list(palavrasReservadas.values())
